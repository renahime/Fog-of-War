...
def seed_lit_posts():
    ...
    post3= Post(
        ...
        text="""<p>I wholeheartedly agree. House of Leaves is predominantly about grief, and the desire to understand or find logic or reason in things that often reject understanding. You can try to understand or break down why someone passed away, just like you can go on countless expeditions to hopefully find the center of a maze, but in the end it will lead you right back to where you started. So much of this book is about letting go, as well as rejecting the notion that closure is a promise.</p><p><br>&nbsp;</p>""",
        user=user2,
        thread=thread2,
    )
    ...
    post4= Post(
        subject="RE: House of Leaves - I believe I've found the profound message at the heart of this book. I might also be insane. Who knows.",
        text="""<p>I agree! It's not about literally ignoring Johnny or any part of the book. It's realizing that none of our unreliable guides can lead us through the labyrinth, because they are themselves lost within it. But by the time you realize the book is playing with these concepts, you are lost in it yourself, seeking answers blindly, just like the characters are. I think that bewildering experience is kinda the point.</p><p>&nbsp;</p><p><br>&nbsp;</p>
              """,
        user=user3,
        thread=thread2,
    )
    ...
    post5 = Post(
        ...
        text="""<p>Great post, I agree. Adding to this: „A novel“ on the book cover is printed in purple, hinting that the whole book is the work of The Author. It‘s pretty likely that The Author is Pelafina. As good as the theory is when you only consider HoL, it basically gets impossible when you consider the screenplays which where released around 2 years ago. In these, TNR is revealed to be a real film. On the other hand, I‘m not sure what to make out of this, as it could just be a move from MZD to make things even more impossible to interpret coherently by intention.</p><p>&nbsp;</p><p>&nbsp;</p>""",
        user=user2,
        thread=thread3,
    )
    ...
    post6 = Post(
        ...
        text="""<p>Interesting take. I went the completely other way and thought that maybe Johnny didn’t exist... and the whole thing was written by Pelafina. But it’s been a couple years since I’ve read it so I’m trying to remember exactly why I came to that conclusion. I think it was because there’s a line in there somewhere about Pelafina and Zampano knowing each other, which obviously shouldn’t be possible if the book is taken at face value. So I thought she created all of Johnny’s world in the throes of her mental illness and grief of the loss of her child. But I also think that is possible to come to a completely different conclusion every time a person reads it.</p><p>&nbsp;</p><p><br>&nbsp;</p>
            """,
        user=user2,
        thread=thread5,
    )
