...
function DeletePostModal({ postId, category, threadId, subcategory, subcategoryId, categoryId }) {
  ...
  const handleDelete = async (e) => {
    ...
    if (deletePost) {
      history.go({ pathname: `/category/${category}/${subcategory}/threads/${threadId}`, state: { category: category, threadId: threadId, subcategory: subcategory, subcategoryId: subcategoryId, categoryId: categoryId } })
    }
  }
  return (
